...
with open('./eval.txt', 'r', encoding='utf-8') as f:
    lines = f.readlines()
    for line in lines:
        shutil.copy2(line.split()[0], f"./dataset/val/{line.split('/')[-2]}")
        print(f"./dataset/val/{line.split('/')[-2]}")
with open('./train.txt', 'r', encoding='utf-8') as f:
    lines = f.readlines()
    for line in lines:
        shutil.copy2(line.split()[0], f"./dataset/train/{line.split('/')[-2]}")
